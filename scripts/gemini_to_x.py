...
def generate_article(topic):
    ...
    - **異なる視点を提示してください**（賛成・反対のバランス）。
    - **具体的なデータや過去の事例を交えて説明してください**。
    - **投稿ごとに異なる切り口を用いてください**（経済、国際関係、歴史、生活影響など）。
    - **100字程度で簡潔かつ具体的に、です・ます調で説明してください**。
    
    ## **今日のテーマ**
    
    金融所得課税の引き上げについて
    
    以下のいずれかの切り口で、毎回異なる視点から説明してください：
    
    1. **歴史的事例** - 過去の金融所得課税引き上げの成功例や失敗例
    2. **経済への影響** - 投資、企業活動、株式市場への影響
    3. **国際比較** - 他国の金融所得課税の現状と日本への示唆
    4. **富裕層の動向** - 課税引き上げによる資産移転の可能性
    5. **一般市民の生活** - 年金や貯蓄、個人投資家への影響
    6. **税収の使い道** - 教育、福祉、社会保障への活用
    7. **政府の意図** - 政策の狙いや背景
    8. **未来の展望** - 日本の税制の長期的な方向性
    
    毎回、ランダムに上記のどれか1つを選び、それを100字程度で簡潔に説明してください。投稿する際はタイトルは省いて文章だけにしてください。
    """
